...
public class ListSort {
    public static void main(String[] args) {
        ...
        //Reverse order
        List<Integer> revSort = sortedList.stream().sorted(Comparator.reverseOrder()).toList();
       // System.out.println(revSort);

        //Using parallel stream
        List<Integer> integerList = sortedList.parallelStream().sorted().toList();
